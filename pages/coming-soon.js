                                ...
                                <div className="d-table">
                                    <div className="d-table-cell">
                                        ...
                                        <div className="social">
                                            <ul>
                                                <li><a href="#" target="_blank" className="twitter"><i className="fab fa-twitter"></i></a></li>
                                                <li><a href="#" target="_blank" className="youtube"><i className="fab fa-youtube"></i></a></li>
                                                <li><a href="#" target="_blank" className="facebook"><i className="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#" target="_blank" className="linkedin"><i className="fab fa-linkedin-in"></i></a></li>
                                                <li><a href="#" target="_blank" className="instagram"><i className="fab fa-instagram"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
